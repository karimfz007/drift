...
function accomplished(): GameState {
    ...
    s.inventory = { wood: 30, stone: 22, fiber: 15, berries: 4, coconut: 2, shellfish: 3, sharpblade: 2, meat: 0, cookedMeat: 0, fish: 0, metal: 0, wiring: 0, glass: 0, medicine: 0, shell: 0, stonehammer: 1, pontoon: 0 };
    s.tools = { axe: true, spear: false, backpack: true, flask: true, flaskSips: 3, axeGrade: 'refined', fishingLine: true, net: true, salvageTools: false };
    ...
    s.storage = { built: true, x: 18, y: -4, durability: 77, tier: 'crate', stored: { wood: 50, stone: 40, fiber: 25 } };
