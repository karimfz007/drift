...
function accomplished(): GameState {
    ...
    s.inventory = { wood: 30, stone: 22, fiber: 15, berries: 4, coconut: 2, shellfish: 3, sharpblade: 2, meat: 0, fish: 0, metal: 0, wiring: 0, glass: 0, medicine: 0, shell: 0, stonehammer: 1 };
