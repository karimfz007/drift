# DRIFT — Ops Protocol v1.2 *(project: The First Night)*
**Team · Process · Protocol** — the operating system for building DRIFT.

**Status:** standing. This file operationalizes Charter Part II. *(v1.1, 2026-07-22 — Phaser-neutral §5; dependency law §5.7. v1.2, 2026-07-22 — three experience fields added to the cycle-spec template in §7, per charter v0.3 §I.18 and D-018.)* If it ever conflicts with the charter, the charter governs; the conflict is logged in the decisions log and reconciled next cycle.
...
/src/body/    Phaser scenes, rendering, input. Imports brain; brain never imports body.
...
**Repo URL:** recorded here at Cycle 01 close (this file → v1.3).

---

*End of Ops Protocol v1.2.*
