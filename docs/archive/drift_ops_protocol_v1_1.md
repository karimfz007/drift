# DRIFT — Ops Protocol v1.1
**Team · Process · Protocol** — the operating system for building DRIFT.

**Status:** standing. This file operationalizes Charter Part II. *(v1.1, 2026-07-22 — Phaser version-neutral wording in §5; dependency law added as §5.7, per charter v0.2 §II.10.)* If it ever conflicts with the charter, the charter governs; the conflict is logged in the decisions log and reconciled next cycle.
...
**Repo URL:** recorded here at Cycle 01 close (this file → v1.2).

---

*End of Ops Protocol v1.1.*
