# DRIFT — Ops Protocol v1.3 *(project: The First Night)*
**Team · Process · Protocol** — the operating system for building DRIFT.

**Status:** standing. This file operationalizes Charter Part II. *(v1.1–v1.2, 2026-07-22 — dependency law §5.7; experience fields in §7. v1.3, 2026-07-22 — repo URL recorded in §8; §5 made engine-neutral for the 3D pivot, charter v0.4 §II.5.)* If it ever conflicts with the charter, the charter governs; the conflict is logged in the decisions log and reconciled next cycle.
