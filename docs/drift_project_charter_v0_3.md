...
**Version:** 0.3 (foundation + engineering + experience)
*(v0.2, 2026-07-22 — library-first audit: Phaser 4 in §II.5; §II.10 engineering addenda. v0.3, 2026-07-22 — title set to **The First Night** (D-015); §I.9 anti-grind reopened, §I.17 psychology rebalanced, §I.18 Experience Constitution added, after the human-enjoyment audit (D-016 … D-018).)*
