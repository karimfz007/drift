...
**Handoff block** (SON): tier on line 1 (Sonnet high default, or Opus if the cycle warrants it); role; boot reading list; doc deltas; then: "confirm boot, execute <cycle> end-to-end with standing authority; once deployed, spawn the C3 audit; on PASS, append the as-built note and report the play URL."
