...
| Routing | What | Gate |
|---|---|---|
| **C1-blocking** | The constitution (charter/ops), forks, the Master Plan itself, and Ch.9 | Still requires C1's explicit **"AUDITED — GO"** relayed by the director before BUILD |
